...
const search = async (req: NextApiRequest, res: NextApiResponse): Promise<void> => {
  ...
  URL = typeof req.query.large_area === undefined ? URL : `${URL}&large_area=${req.query.largeArea}`;
  ...
  URL = typeof req.query.privateRoom === undefined ? URL : `${URL}&private_room=${req.query.privateRoom}`;
